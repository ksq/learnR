...
The following code implements such a function by using *flow control*, which we will cover in the next chapter. In the code, whose expression is to be evaluated depends on the value of `type`.
